...
<div class="wrapper-buy">
    ...
    <div id="header-nav">
        <ul class="nav">
            <li>品牌  :</li>
            <a href="index.php/user/dazhong"><li>大众</li></a>
            <a href="index.php/user/xiandai" class="ss"><li>现代</li></a>
            <!-- <a href=""><li>丰田</li></a>
            <a href=""><li>日产</li></a>
            <a href=""><li>福特</li></a>
            <a href=""><li>奇瑞</li></a>
        ...
        <ul class="nav"> 
            <li>车系  :</li>
            <a href="index.php/user/chexi?id=高尔夫"><li>高尔夫</li></a>
            <a href="index.php/user/chexi?id=伊兰特"><li>伊兰特</li></a>
            <a href="index.php/user/chexi?id=途胜"><li>途胜</li></a>
            <!-- <a href=""><li>速腾</li></a>
            <a href=""><li>迈腾</li></a>
            <a href=""><li>捷达</li></a>
...
<script type="text/javascript" charset="utf-8">
	$(function(){    //文档就绪函数，所有dom节点都解析后开始执行
				 ...
				 //第三个参数是异步回掉函数，data是php往回传得值，是个字符串
                     ...
                     $.post("http://localhost/carsale1/index.php/user/do_xiandai",{},function(data){
				    
	                $("#clear ul").empty("");
						
					 					 					
					 for(var i=0;i<data.length;i++){
						 var trTD='<li><div class="list-infoBox"><a title="' + data[i].carname +'"  class="imgtype" href="index.php/user/detail?id=' + data[i].carimgurl +'"><img width="290" height="194" src="' + data[i].carimgurl + 
						 '" alt=""></a><p class="infoBox"><a title="' + data[i].carname + '" href="" target="_blank" class="info-title">' + data[i].carname + 
						 '</a></p><p class="fc-gray"><span class="">' + data[i].sptime + '上牌</span></p><p class="priType-s"><em class="tag-yellow">超值</em><span><i class="fc-org priType">'
						 + data[i].ncarprice + '万</i></span><s>' + data[i].ocarprice + '万</s></p></div></li>';
					 	 
					 	 $("#clear ul").append(trTD);
